...
#PA comment:
# this value appears to be based on NextSeq  runs? Not used in analysis
#
#NORMAL_READS_NextSeq = 40000000
#
#for HiSeq runs the number of reads on average is 100000000 - Not used in analysis
#NORMAL_READS_HiSeq4000=100000000
...
def calculate_exp_depth(flagstats, filenames, outfile, force=False ):
	...
	comment_line = False
		...
		continue
            ...
            #there is no need for normalisation of the depth. The values are correct without the following calculation.
            #mean_depth = mean_depth * NORMAL_READS_HiSeq4000/flagstats[ sample_name ]['usable_reads' ]
